 ...
 */
public class HorzScrollWithProfileMenu extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        imageView05.setOnClickListener(new HorzScrollWithListMenu.ClickListenerForScrolling(scrollView, menu));
