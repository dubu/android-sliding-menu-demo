 ...
 */
public class HorzScrollWithVideoMenu extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        imageView04.setOnClickListener(new HorzScrollWithListMenu.ClickListenerForScrolling(scrollView, menu));
